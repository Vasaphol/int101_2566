...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println(work03.MyUtil.calculateBMI(54, 20.5));
       System.out.println(work03.MyUtil.avg(5, 6, 7));
   ...
   static void work04UseOfObjectClass() {
    ...
    System.out.println("Account 1: " + account1.toString() + ", Balance: " + account1.getBalance());
    System.out.println("Account 2: " + account2.toString() + ", Balance: " + account2.getBalance());
